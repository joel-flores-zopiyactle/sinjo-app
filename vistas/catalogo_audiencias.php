...
<div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Administración de audiencias</h2>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">
                            <strong>Tipos de audiencias</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
...
<div class="wrapper wrapper-content animated fadeInRight">
                        ...
                        <div class="row">
                            <div class="col-sm-6 ">
                                <form name="formulario" id="formulario" method="post">
                                    <input type="hidden" name="idtipaudiencia" id="idtipaudiencia">
                                    <div class="form-group"><label>Nombre:</label> <input type="text" id="tipaudiencianame" name="tipaudiencianame" placeholder=""  onkeyup="mayus(this);" class="form-control"></div>
        ...
        <script src="scripts/catalogo_audiencias.js"></script>
